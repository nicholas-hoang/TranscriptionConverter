...
class TranscriptionConverter:
    ...
    def convert_and_write(self, output_filename="data/concatenated_text-CLEANED.docx"):
        df = self.docx_to_txt()
        ...
        self.write_to_word_doc(concatenated_data, output_filename)
    ...
    def run_module(self):
        ...
        if file_path and os.path.exists(file_path):
            ...
            self.feedback_label.config(
                text="File processing completed successfully. ヾ( ˃ᴗ˂ )◞ • *✰ ",
                fg="green",
            )
        else:
            self.feedback_label.config(
